...
@SourceType(value = "AdobeCommerceARP", label = "AdobeCommerce",uiConfig = "adobecommerce-layout.json")
public class AdobeCommerceConf extends AbstractArpConf<AdobeCommerceConf> {
  private static final String ARP_FILENAME = "arp/implementation/adobecommerce-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.adobecommerce.AdobeCommerceDriver";
